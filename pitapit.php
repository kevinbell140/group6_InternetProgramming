    ...
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron">
                ...
                <h1 class="display-3">Pita Pit</h1>
                <p class="lead">A pit for pitas </p>
                <hr class="my-4">
                <p class="lead">
                    <?php
                    //overall rating
                    ...
                    $query = $conn->prepare("SELECT Post.rating FROM Post WHERE Post.eateryID = 6");
                    $query->execute();
                    ...
                    if($username == ""){
                        ...
                        echo "<a class='btn btn-primary btn-lg' href='../posts/review.php?eateryID=6' role='button'>Leave a review!</a>";
                    }
                    ?>
                </p>
            </div>
