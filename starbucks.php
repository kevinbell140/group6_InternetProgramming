...
<div class="container">
        ...
        <div class="col-md-12">
            <div class="jumbotron">
                ...
                <p class="lead">
                    ...
                    $query = $conn->prepare("SELECT Post.rating FROM Post WHERE Post.eateryID = 3");
                    $query->execute();
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            $query2 = $conn2->prepare("SELECT Post.postID, Post.title, Post.review, Post.rating, User.userName, Eatery.eateryName, Post.time, Post.userID, Post.helpful FROM Post INNER JOIN Eatery ON Post.eateryID = Eatery.eateryID INNER JOIN User ON Post.userID = User.userID WHERE Post.eateryID = 3 ORDER BY Post.time DESC");
            $query2->execute();
